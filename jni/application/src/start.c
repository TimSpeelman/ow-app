...
void Java_org_openwallet_android_PythonActivity_nativeSetenv(
...
void Java_org_openwallet_android_PythonActivity_nativeInit(JNIEnv* env, jclass cls, jobject obj)
{
